...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CodeToCompile.language'
        db.alter_column(u'onlinejudge_codetocompile', 'language', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CodeToCompile.language'
        db.alter_column(u'onlinejudge_codetocompile', 'language', self.gf('django.db.models.fields.IntegerField')(default=0))
